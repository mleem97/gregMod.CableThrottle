# AGENTS.md — Hinweise für KI-Agenten (gregMod.CableThrottle)

Repo: [https://github.com/mleem97/gregMod.CableThrottle](https://github.com/mleem97/gregMod.CableThrottle) · Lizenz: Apache-2.0 · Version: siehe `VERSION`.
